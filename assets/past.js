let seccionp = document.getElementById("cartasp");
...
const pastEvents = data.events.filter(events => new Date(events.date) < currentDate);
...
function asignar(lista){
    ...
    seccionp.innerHTML = template
}

let eventos = pastEvents;
